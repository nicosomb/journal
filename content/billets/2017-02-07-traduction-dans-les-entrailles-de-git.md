...
![HEAD pointant sur master et master pointant sur le commit a1](/images/2017-02-07-traduction-dans-les-entrailles-de-git/3-a1-refs.png)
...
![Le commit a1, affiché avec la copie de travail et l'index](/images/2017-02-07-traduction-dans-les-entrailles-de-git/4-a1-wc-and-index.png)
...
![Le commit `a2`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/7-a2.png)

_Image : Le commit `a2`_

![Le graphe Git, sans index ni copie de travail](/images/2017-02-07-traduction-dans-les-entrailles-de-git/8-a2-just-objects-commits-and-refs.png)
...
![Le commit `a3` qui n'est pas sur une branche](/images/2017-02-07-traduction-dans-les-entrailles-de-git/10-a3-detached-head.png)
...
![Le commit `a3`, désormais sur la branche `deputy`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/11-a3-on-deputy.png)
...
![Le commit `a3` de la branche `deputy`, fusionné en avance rapide sur la branche `master`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/15-a3-on-master.png)
...
![`a3`, le commit de base pour `a4` et `b3`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/17-a4-b3-on-deputy.png)
...
![`b4`, le commit de fusion obtenu suite à la fusion récursive de `a4` sur `b3`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/18-b4-on-deputy.png)
...
![L'écriture de `MERGE_HEAD` lors de la fusion de `b5` sur `b6`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/21-b6-on-master-with-merge-head.png)
...
![`b11`, le commit de fusion provenant de la fusion récursive conflictuelle entre `b5` et `b6`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/22-b11-on-master.png)
...
![Le nouveau graphe créé lorsqu’`alpha` est copié en `bravo` avec `cp`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/26-11-cp-alpha-to-bravo.png)
...
![`alpha` après avoir récupéré `bravo/master`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/28-12-fetched-to-alpha.png)
...
![Le commit `14` poussé depuis `alpha` vers `delta`](/images/2017-02-07-traduction-dans-les-entrailles-de-git/32-14-pushed-to-delta.png)
