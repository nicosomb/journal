...
Les 2 noms de domaine concernés (`wllbg.org` et `wallabag.org`) étaient en renouvellement automatique (première erreur).  
Je n'ai pas fait attention aux mails de relance (deuxième erreur).  
Ma carte bancaire sauvegardée chez Gandi avait expiré depuis quelques jours (troisième erreur). 
